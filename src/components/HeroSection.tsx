...
const HeroSection: React.FC = () => {
  ...
  // Set a future date for the countdown (e.g., August 23rd as per timeline)
  useEffect(() => {
  ...
  return <div className="min-h-screen w-full flex flex-col justify-center items-center pt-20 pb-10 px-4">
      <div className="max-w-6xl w-full">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h2 className="text-xl md:text-3xl text-white mb-8" initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
          ...
          <motion.div className={`text-xl md:text-3xl mb-12 ${fonts[currentFont]}`} initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
          ...
          duration: 0.8
            ...
            <div className="mb-2 text-[#ff2a93]">PREPARE FOR REVELATION.</div>
            <div className="mb-2 text-white">HEIGHTEN YOUR SENSES.</div>
            <div className="text-[#2ef2ff]">THE UNVEILING NEARS.</div>
          </motion.div>
          <div className="flex flex-col md:flex-row justify-center gap-6 mb-16">
            <motion.button className="px-8 py-4 bg-gradient-to-r from-[#ff2a93] to-[#7a2aff] text-white font-bold rounded-full text-lg hover:shadow-[0_0_15px_rgba(255,42,147,0.8)] transition-shadow" whileHover={{
            scale: 1.05
          }} whileTap={{
            scale: 0.95
          }}>
          ...
          <div className="bg-black bg-opacity-50 backdrop-blur-sm p-8 rounded-xl">
            ...
            }].map(item => <div key={item.label} className="flex flex-col items-center">
