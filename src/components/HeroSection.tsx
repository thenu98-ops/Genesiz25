      ...
      <div className="min-h-screen max-w-6xl w-full h-full flex flex-col justify-end pb-12 lg:pb-4 md:pb-12 relative z-10">
        ...
        <div className="text-center">
          ...
          >
            ...
            <motion.div className="mb-1 text-white">
              HEIGHTEN YOUR SENSES
            </motion.div>
            <motion.div className="text-[#2ef2ff]">
              THE UNVEILING NEARS
            </motion.div>
          </motion.div>
          ...
          <div className="flex justify-center">
            <div className="bg-black bg-opacity-50 backdrop-blur-sm p-6 rounded-xl w-full max-w-2xl mx-4 sm:mx-0">
              <h3 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#ff2a93] via-[#2ef2ff] to-[#7a2aff] animate-pulse text-center mb-3">
                🚀 Happening Now 🚀
              </h3>
              <p className="text-gray-300 text-sm sm:text-base md:text-lg text-center">
                You can see live score in the scoreboard
              </p>
            </div>
          </div>
